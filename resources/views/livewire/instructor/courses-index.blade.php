<div class="container py-8">
    <x-table-responsive>
        <div class="flex px-6 py-4">
            <input type="text" wire:model="search" class="form-input rounded-lg flex-1 shadow-sm"
                    ...
                    @foreach ($courses as $course)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500">Studenst</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex item-center text-sm text-gray-900">
                                    {{ $course->rating }}
                                    <div class="flex">
                                ...
                                <div class="text-sm text-gray-500">Course valorations</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
