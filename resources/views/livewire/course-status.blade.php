    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between mt-4">
                ...
                <div wire:click="completed" class="flex items-center cursor-pointer">
                ...
                <div class="card-body flex font-bold text-gray-500">
                    @if ($this->previous)
                        <a wire:click="changeLesson({{ $this->previous }})"
                            class="cursor-pointer hover:text-gray-700">Tema anterior</a>
                    @endif
                    @if ($this->next)
                        <a wire:click="changeLesson({{ $this->next }})"
                            class="cursor-pointer ml-auto hover:text-gray-700">Siguiente tema</a>
                    @endif
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <h1 class="text-2xl leading-8 text-center mb-4 text-gray-600">{{ $course->title }}</h1>
