            ...
            <section class="card mb-12">
                <div class="card-body">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        @empty
                            <li>Este curso no tiene asignado ninguna meta</li>
                        @endforelse
                    </ul>
                </div>
            </section>
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.courses.approved', $course) }}" method="POST">
                        @csrf
                        <button class="btn btn-blue w-full mt-4">Aprovar curso</button>
                    </form>

                    <a href="{{ route('admin.courses.observation',$course) }}"
                        class="btn btn-red w-full mt-4 block text-center">Observar curso</a>
                </div>
            </section>
